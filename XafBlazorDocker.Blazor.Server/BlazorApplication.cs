...
using XafBlazorDocker.Blazor.Server.Services;


namespace XafBlazorDocker.Blazor.Server {
    public partial class XafBlazorDockerBlazorApplication : BlazorApplication {
        public XafBlazorDockerBlazorApplication() {
            InitializeComponent();
            this.ConnectionString= InMemoryDataStoreProvider.ConnectionString; 
        }
        ...
        private void XafBlazorDockerBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
